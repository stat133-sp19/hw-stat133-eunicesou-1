...
![Cozy Cabbage and Farro Soup](
/Users/eunice/Downloads/cozy-cabbage-and-farro-soup.png)
...
In Cartesian coordinates, if **p** = $(p_1, p_2,..., p_n)$ and **q** = $(q1, q2,..., qn)$ are two points in Euclidean n-space, then the distance (d) from **p** to **q**, or from q to p is given by the Pythagorean formula:

\begin{equation}
\partial(\boldsymbol{p},\boldsymbol{q}) = \partial(\boldsymbol{q},\boldsymbol{p})= \sqrt{(q_1-p_1)^2+(q_2-p_2)^2+\dots+(q_n-p_n)^2} \\
